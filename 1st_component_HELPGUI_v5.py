...
class Help:
    def __init__(self, partner): # what is partner?
        ...
        # if users press cross at top, it will close 'help' and and 'releases' help button
        ...
        # changed from command= self to command=partial

        self.dismiss_button.grid(row=2, pady=10)

    def close_help(self, partner):
        # put help button back to normal...
        partner.help_button.config(state=NORMAL) # returns the 'disabled' to 'normal' to make it reopenable
